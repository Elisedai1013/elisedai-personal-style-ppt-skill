...
<p>
  <a href="https://agentskills.io/"><img src="https://img.shields.io/badge/Agent_Skills-compatible-276EF1?style=flat-square" alt="Agent Skills compatible"></a>
  <img src="https://img.shields.io/badge/Output-editable_PPTX-111111?style=flat-square" alt="Output: editable PPTX">
  <img src="https://img.shields.io/badge/Palette-black_white_signal_blue-555555?style=flat-square" alt="Palette: black, white and Signal Blue">
  <img src="https://img.shields.io/badge/Language-中文-555555?style=flat-square" alt="Language: Chinese">
</p>

<img src="examples/episode-02/cover.jpg" alt="AI Builders 解读 02：EliseDai 个人风格 PPT 示例" width="760">
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <img src="examples/episode-02/screenshot-comparison.jpg" alt="同一份剧本可以是完全不同的演出" width="100%"><br>
      保留原始画面比例和可读区域，通过一致尺寸、留白、标题和注释建立比较关系。
    </td>
    <td width="50%" valign="top">
      <strong>抽象观点变成视觉隐喻</strong><br><br>
      <img src="examples/episode-02/concept-spine.jpg" alt="先给作品一条主心骨" width="100%"><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <img src="examples/episode-02/screenshot-dark-stage.jpg" alt="一个双击 Command 排练了一年" width="100%"><br>
      产品截图保持原有界面颜色；统一感来自裁切、比例、位置与舞台关系，不来自强制改色。
    </td>
    <td width="50%" valign="top">
      <strong>人物与空间共同讲故事</strong><br><br>
      <img src="examples/episode-02/audience-line-art.jpg" alt="观众是作品的一部分" width="100%"><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <img src="examples/episode-02/metaphor-delete-nine.jpg" alt="删掉九个并为留下的那个负责" width="100%"><br>
      一排被淘汰的方案和唯一蓝色出口，直接承担“删掉九个”的判断。
    </td>
    <td width="50%" valign="top">
      <strong>结尾回答开头</strong><br><br>
      <img src="examples/episode-02/closing.jpg" alt="AI 写剧本，Builder 决定演出" width="100%"><br>
